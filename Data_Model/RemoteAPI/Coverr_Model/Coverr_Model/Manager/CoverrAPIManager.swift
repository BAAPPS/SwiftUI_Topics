...
//        }
    ...
    func fetchCollectionAsync(
        endpoint: CoverrEndpoints = .collections,
        page: Int? = nil,
        pageSize: Int = 20,
        ...
        // Build URL string
        var components = URLComponents(string: "https://api.coverr.co/collections")
...
//        }
        ...
        do {
            ...
            decoder.keyDecodingStrategy = .useDefaultKeys
            decoder.dateDecodingStrategy = UniversalDateDecoder.decodingStrategy
            let collections = try decoder.decode(CollectionModel.self, from: data)
            return collections
        } catch let decodingError as DecodingError {
            var message: String
            switch decodingError {
